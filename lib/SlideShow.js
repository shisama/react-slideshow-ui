...
const calcProgress_1 = __importDefault(require("./calcProgress"));
    ...
    constructor(props) {
        ...
        this.calcProgressIndex = (e) => {
            ...
            for (let i = 0; i < this.props.images.length; i++) {
                const checkWidth = calcProgress_1.default(i, this.props.images.length);
        ...
        this.updatePageState = (index) => {
            const progress = calcProgress_1.default(index + 1, this.props.images.length);
