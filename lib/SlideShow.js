...
const shallow_equal_object_1 = __importDefault(require("./shallow-equal-object"));
...
class SlideShow extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (shallow_equal_object_1.default(this.props, nextProps)) {
            return true;
        }
        if (shallow_equal_object_1.default(this.state, nextState)) {
            return true;
        }
